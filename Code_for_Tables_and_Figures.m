...
%% The following part was originally typed in the command window:
...
clear,clc
%%Table 3: Numerical errors and the temporal convergence orders of the extrapolation solution UnE,j for ¦Á1 = 1.2, ¦Á2 = 1.8 with h = 0.01 at T = 0.5.
h=1/100;
...
clear,clc
%%Fig.1. The evolution of Mass (Fig.1.a) and Energy (Fig.1.b) for different alpha
tau=1/100;
h=1/2;
alpha_u=[1.5,1.8,2];
alpha_v=[2,1.2,2];
...
clear,clc
%%Fig.2. Absolute errors of mass (Fig.2.a) and energy (Fig.2.b) for different alpha
tau=1/1000;
h=1/2;
alpha_u=[1.5,1.8,2];
alpha_v=[2,1.2,2];
...
clear,clc
%%Fig.3. The evolution of the absolute errors of mass (Fig.3.a) and energy (Fig.3.b) for different spatial grid sizes M
...
clear,clc
%%Fig.4.The evolution of mass (Fig.4.a) and energy (Fig.4.b) after applying the high-order explicit Richardson extrapolation method
tau=[1/100,1/200];
h=1/2;
alpha_u=[1.5,1.8,2];
alpha_v=[2,1.2,2];
...
%Fig.5. Absolute errors of mass (Fig.5.a) and energy (Fig.5.b) after applying the high-order explicit Richardson extrapolation method
figure(3); %Fig.5. (a)
t= 0:tau:0.5;
loglog(t,ErrM_cell{1,1},'b--o'...
,t,ErrM_cell{2,1},'r--x'...
